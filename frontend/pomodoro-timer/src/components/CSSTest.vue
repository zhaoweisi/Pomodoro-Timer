<template>
    ...
    <body>
        ...
        <div class="timer-button-group" >
            <button type="button" class="timer-button" ><i
                    class="fa fa-play"></i> Start</button>
            <button type="button" class="timer-button"><i
                    class="fa fa-pause"></i> Pause/Resume</button>
            <button type="button" class="timer-button"><i
        ...
        <div class="timer-button-group" >
            <button type="button" class="timer-button timer-button2" ><i
                    class="fa fa-play"></i> Start</button>
            <button type="button" class="timer-button timer-button2"><i
                    class="fa fa-pause"></i> Pause/Resume</button>
            <button type="button" class="timer-button timer-button2"><i
